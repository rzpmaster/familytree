  ...
  return (
    <>
      <div className="flex items-center justify-between w-full bg-purple-50 rounded border border-purple-100 px-2 py-2 mb-1 last:mb-0">
        <span
          className="text-purple-700 truncate mr-2 text-xs flex-1"
          title={familyName || sf.family_id}
        >
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              onClick={() =>
                handleRoleChange(sf.role === "admin" ? "editor" : "admin")
              }
              disabled={isUpdating}
      ...
      <ConfirmDialog
        ...
        title={t("family.remove_collaborator", {
          defaultValue: "Remove Collaborator",
        })}
        message={t("family.confirm_remove_collaborator", {
          defaultValue: "Are you sure you want to remove this collaborator?",
        })}
