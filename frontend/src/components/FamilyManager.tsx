...
const FamilyManager: React.FC<FamilyManagerProps> = ({ families, currentFamily, onSelectFamily, onFamilyCreated }) => {
    ...
    return (
        <div className="relative">
                ...
                <div className="absolute top-full left-0 mt-2 w-72 bg-white rounded-lg shadow-lg border p-2 z-50">
                    {!isCreating ? (
                        ...
                        <div className="p-1 space-y-3">
                            ...
                            <div>
                                <label className="block text-xs text-gray-500 mb-1">{t('owner') || 'Owner'}</label>
                                <select
            ...
            <ConfirmDialog 
                ...
                title={t('family.delete') || 'Delete Family'}
                message={t('family.confirm_delete', { name: familyToDelete?.family_name }) || `Are you sure you want to delete family '${familyToDelete?.family_name}'?`}
