...
def create_spouse_relationship(
    relationship: schemas.SpouseRelationshipCreate, db: Session = Depends(get_db)
):
...
def create_parent_child_relationship(
    relationship: schemas.ParentChildRelationshipCreate, db: Session = Depends(get_db)
):
    # Basic validation
...
def update_spouse_relationship(
    relationship_id: str,
    relationship: schemas.SpouseRelationshipUpdate,
